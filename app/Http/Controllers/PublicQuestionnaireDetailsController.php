...
class PublicQuestionnaireDetailsController extends Controller
{
    public function show($type)
    {
        ...
        if (!$activePeriod) {
            return redirect()->route('home')->with('error', 'Tidak ada periode akademik tersedia');
        }
        ...
        if (!$questionnaire) {
            return redirect()->route('home')->with('error', 'Kuesioner tidak ditemukan');
        }
        ...
        if (!$responses->isEmpty()) {
            // Hitung rata-rata per kategori menggunakan metode yang sama seperti controller lain
            ...
            // Hitung distribusi rating untuk keperluan chart
            ...
            // Jika tidak ada responses, gunakan data kosong
        ...
        return view('public.questionnaire-details', compact(
            'questionnaire',
            'type',
            'categories',
            'categoryAverages',

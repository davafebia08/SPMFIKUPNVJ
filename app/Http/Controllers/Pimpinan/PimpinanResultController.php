...
class PimpinanResultController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pimpinan.results.index', compact(
            'academicPeriods',
            'selectedPeriodId',
    ...
    public function show(Questionnaire $questionnaire, Request $request)
    {
        ...
        if ($responses->isEmpty()) {
            return redirect()->route('pimpinan.results.index')
        ...
        return view('pimpinan.results.show', compact(
            'questionnaire',
            'categoryRatings',
            'questionRatings',
            'overallAverage',
    ...
    public function respondents(Questionnaire $questionnaire, Request $request)
    {
        ...
        return view('pimpinan.results.respondents', compact(
            'questionnaire',
            'respondents',
            'selectedRole',
            'searchQuery',
    ...
    public function respondentDetail(Questionnaire $questionnaire, User $user)
    {
        ...
        if (!$submission) {
            return redirect()->route('pimpinan.results.respondents', $questionnaire)
        ...
        return view('pimpinan.results.respondent-detail', compact(
            'questionnaire',
            'user',
            'responses',
            'questionsByCategory',

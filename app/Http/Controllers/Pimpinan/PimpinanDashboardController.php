...
class PimpinanDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pimpinan.dashboard.index', compact('academicPeriods', 'activePeriod', 'selectedPeriodId', 'selectedProdi', 'programStudiOptions', 'dashboardData', 'isAllPeriods'));
    }

...
<head>
    ...
    <title>@yield('title', 'Pimpinan - SPM FIK UPNVJ')</title>
    ...
    <style>
        :root {
            ...
            /* Biru untuk pimpinan, berbeda dengan orange admin */
            --primary-dark: #3A56B7;
            ...
            --bg-light: #ffffff;
            --border-color: #E0E0E0;
            --card-shadow: 0 4px 12px rgba(78, 115, 223, 0.1);
        }
    ...
    <div id="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('pimpinan.results.*') ? 'active' : '' }}" href="{{ route('pimpinan.results.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('pimpinan.reports.*') ? 'active' : '' }}" href="{{ route('pimpinan.reports.index') }}">
        ...
        <div id="content">
            ...
            <nav id="topbar" class="navbar navbar-light bg-white mb-4 static-top shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <span class="d-none d-md-inline-block">Pimpinan Fakultas</span>
                </div>

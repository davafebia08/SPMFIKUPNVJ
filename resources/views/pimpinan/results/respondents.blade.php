    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            ...
            <div class="mt-3 mt-md-0">
                <a href="{{ route('pimpinan.results.show', ['questionnaire' => $questionnaire]) }}" class="btn btn-info">
                    <i class="fas fa-chart-bar me-1"></i> Lihat Hasil
                </a>
                <a href="{{ route('pimpinan.results.index') }}" class="btn btn-outline-primary ms-2">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('pimpinan.results.respondents', $questionnaire) }}" method="GET">
                    <div class="row">
                        <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('pimpinan.results.respondent-detail', [$questionnaire->id, $respondent->id]) }}"
                                                class="btn btn-sm btn-primary" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <form action="{{ route('pimpinan.results.delete-response', [$questionnaire->id, $respondent->id]) }}"

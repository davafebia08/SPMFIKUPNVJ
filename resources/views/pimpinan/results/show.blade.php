    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            ...
            <div class="mt-3 mt-md-0">
                <a href="{{ route('pimpinan.results.respondents', ['questionnaire' => $questionnaire, 'program_studi' => $selectedProdi]) }}"
                    class="btn btn-info">
        ...
        @if (!in_array($questionnaire->type, ['kepuasan_pengguna_lulusan', 'kepuasan_mitra']))
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('pimpinan.results.show', $questionnaire) }}" method="GET" id="filterForm">
                        <div class="row">

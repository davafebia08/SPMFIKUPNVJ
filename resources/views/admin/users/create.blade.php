...
@section('title', 'Tambah User Baru - Admin SPM FIK UPNVJ')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="mb-0 text-muted">Tambahkan pengguna baru ke sistem SPM</p>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                                        <option value="" selected disabled>Pilih Kategori User</option>
                                        ...
                                        <div class="card-body">
                                            <div class="row role-fields" id="fields-mahasiswa">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select @error('program_studi') is-invalid @enderror" id="program_studi"
                                                        ...
                                                        <option value="S1 Informatika" {{ old('program_studi') == 'S1 Informatika' ? 'selected' : '' }}>
                                                            S1 Informatika</option>
                                                        <option value="S1 Sains Data" {{ old('program_studi') == 'S1 Sains Data' ? 'selected' : '' }}>S1
                                                            Sains Data</option>
                                                        <option value="S1 Sistem Informasi"
                                                            {{ old('program_studi') == 'S1 Sistem Informasi' ? 'selected' : '' }}>S1 Sistem Informasi
                                                        </option>
                                                        <option value="D3 Sistem Informasi"
                                                            {{ old('program_studi') == 'D3 Sistem Informasi' ? 'selected' : '' }}>D3 Sistem Informasi
                                                        </option>
                                                    </select>
                                                    @error('program_studi')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="row role-fields" id="fields-alumni">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('nim') is-invalid @enderror" id="alumni_nim"
                                                        name="nim" value="{{ old('nim') }}">
                                                    @error('nim')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror

...
@section('title', 'Hasil Kuesioner - Admin SPM FIK UPNVJ')
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            @if ($data['respondent_count'] > 0)
                                                <a href="{{ route('admin.results.show', ['questionnaire' => $data['questionnaire'], 'program_studi' => $selectedProdi]) }}"
                                                    class="btn btn-sm btn-primary" title="Lihat Detail">
                                                    <i class="fas fa-chart-bar"></i>
                                                </a>
                                                <a href="{{ route('admin.results.respondents', ['questionnaire' => $data['questionnaire'], 'program_studi' => $selectedProdi]) }}"

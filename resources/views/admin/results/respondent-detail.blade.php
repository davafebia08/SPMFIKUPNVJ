<!-- resources/views/admin/results/respondent-detail.blade.php -->
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            ...
            <div class="mt-3 mt-md-0">
                <a href="{{ route('admin.results.respondents', $questionnaire) }}" class="btn btn-outline-primary">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.results.delete-response', [$questionnaire->id, $user->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')

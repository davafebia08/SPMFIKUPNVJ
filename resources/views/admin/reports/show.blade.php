    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('admin.reports.print', ['report' => $questionnaire->id, 'orientation' => 'portrait']) }}"
                    class="btn btn-outline-primary btn-sm shadow-sm" target="_blank">
                    <i class="fas fa-print me-1"></i> Cetak Laporan
                </a>
                <a href="{{ route('admin.reports.print', ['report' => $questionnaire->id, 'orientation' => 'landscape']) }}"
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.results.respondents', $questionnaire->id) }}" class="btn btn-sm btn-primary">
                        ...
                        <tbody>
                            @foreach ($responses->groupBy('user_id')->take(10) as $userId => $userResponses)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.results.respondent-detail', [$questionnaire->id, $userId]) }}"
